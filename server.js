...
app
    ...
    try {
        ...
        if (customPet) {
            ...
            if (!data.animal) {
                console.warn(`Pet ${petId} not found in API. Removing from favorites anyway.`);
        ...
        if (isFavorited) {
            ...
            console.log('Removed favorite. Mongo result:', result);
                    ...
                    { _id: ownerId },
                    {
                        $push: {
                            notifications: {
                                ...
                                image: liker.profileImage,
                                message: `${liker.firstName} liked your pet "${pet.name}"`,
                                petId,
                                timestamp: Date.now(),
                                status: 'pending',
